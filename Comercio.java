...
public class Comercio {
    ...
    static Lista<Pedido> pedidosCadastradosPermanente = new Lista<>();
    ...
    */
    ...
    public static void valorMedio(){
        System.out.print("Digite a quantidade de pedidos para calcular a média dos itens: ");
        int quant = teclado.nextInt();
        teclado.nextLine(); 
        double media = pedidosCadastradosPermanente.calcularValorMedio(
            pedido -> pedido.valorMedioDosItens(), 
            quant
        );

        System.out.println("Média do valor dos itens nos pedidos: R$ " + media);
    }

    public static void valorMedioInterativo(){
        System.out.print("Digite a quantos dos primeiros pedidos serão calculados a média: ");
        int quant = teclado.nextInt();
        teclado.nextLine();
        double media = pedidosCadastradosPermanente.valorMedioInterativo(
        pedido -> pedido.valorFinal(), quant);
        System.out.println("Valor médio dos pedidos: R$ " + media);
    }

    public static void filtrar(){
        System.out.print("Digite a quantidade de pedidos para serem filtrados: ");
        int quant = teclado.nextInt();
        teclado.nextLine();
        System.out.print("Digite o valor minimo dos pedidos a serem exibidos: ");
        double valor = teclado.nextDouble();
        teclado.nextLine();
        Lista<Pedido> filtrada = pedidosCadastradosPermanente.filtrar(
            pedido -> pedido.valorFinal()>valor, quant);
